...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-r from-sky-100 via-indigo-100 to-violet-100 px-4 py-10 sm:px-8 sm:py-14">
      ...
      <div className="grid w-full max-w-7xl overflow-hidden rounded-3xl bg-white shadow-[0_30px_80px_-30px_rgba(15,23,42,0.25)] ring-1 ring-slate-200/70 lg:min-h-[600px] lg:grid-cols-[1fr_1fr]">
        ...
        <div className="relative flex flex-col">
          {/* PNG cropped to the logo bounds then padded horizontally to
              2150×430 (5:1) so it renders edge-to-edge at its natural ratio,
              giving a shorter band height without cropping the logo. */}
          <div className="bg-slate-100">
            <Image
              src="/auth-logo-v5.png"
              alt="Bird Eye Viewer"
              width={2150}
              height={430}
              priority
          ...
          <section className="flex flex-1 flex-col px-8 pb-10 pt-8 sm:px-12 sm:pb-12 lg:px-14 lg:pb-12">
