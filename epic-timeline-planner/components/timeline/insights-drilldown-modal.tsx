...
export function InsightsDrilldownModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="relative flex h-[78vh] w-full max-w-[1500px] flex-col overflow-hidden rounded-2xl border border-sky-200 bg-white shadow-2xl ring-4 ring-sky-100/70 animate-in fade-in zoom-in-95 duration-150"
